...
public class SetDefaultVacationTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        log.info(">>>>> This is SetDefaultVacationTasklet");
        log.info(">>>>> This is requestDate = {}", requestDate);
        vacationBatchService.setDefaultVacation(requestDate);
