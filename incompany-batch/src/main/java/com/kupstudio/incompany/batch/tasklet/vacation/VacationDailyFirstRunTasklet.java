...
public class VacationDailyFirstRunTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        log.info(">>>>> This is vacationDailyFirstRunTasklet");
        log.info(">>>>> This is requestDate = {}", requestDate);
        vacationBatchService.vacationDailyFirstRun(requestDate);
