$(document).ready(function () {
    ...
    page.on('click', function () {
        ...
        $(location).attr('href', "/faQuestion/list?" +
            "pageNum=" + pageNum
    ...
    $(document).on('click', '._searchBtn', function () {
        ...
        if(searchType == 'createDate'){
            if ( !DATE_TIME_CHECK.test(keyword) ) {
                ...
                location.href = '/faQuestion/list?searchType=' + searchType+'&keyword='+keyword;
            }
        }else{
            location.href = '/faQuestion/list?searchType=' + searchType+'&keyword='+keyword;
        }
    ...
    //ul 클릭 시 경로 이동
    $(document).on('click', '._questionList > li', function(){
        const questionNo = $(this).parent().attr('value');
        const url = "/faQuestion/questionInfo?questionNo=" + questionNo;
