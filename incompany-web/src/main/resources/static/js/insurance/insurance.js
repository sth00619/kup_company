$(document).ready(function () {
    ...
    $(document).on('click', '._insurance_sub > li', function () {
        ...
        if (!$(this).hasClass('_checkbox_li') && typeof insuranceManageNo != 'undefined' && insuranceManageNo !== '' && insuranceManageNo != null) {
            const url = "/insurance/insuranceInfo?insuranceManageNo=" + insuranceManageNo;
    ...
    function searchContractFortune() {
        ...
        $(location).attr('href', "/insurance/insurance?" + url);
    }
    ...
    $('._contract_transfer').on('click', function () {
        ...
        if (typeof transferEmployeeCode != 'undefined' && transferEmployeeCode !== '' && transferEmployeeCode != null) {
            const insuranceCodeList = getCheckInsuranceCodeList();
            if (typeof insuranceCodeList != 'undefined' && insuranceCodeList !== '' && insuranceCodeList != null) {
                // url parameter 추가
                ...
                // url 문자열 세팅
                const url = settingUrl(urlArray);
                $(location).attr('href', "/insurance/transferEmployeeInsurance?" + url + insuranceCodeList);
    ...
    // 체크되어 있는 계약 찾기
    function getCheckInsuranceCodeList() {
        let insuranceCodeList = '';
        $('._sub_check:checked').each(function () {
            insuranceCodeList += "&insuranceCodeList=" + $(this).parents('._sub_ul').attr('value');
        });
