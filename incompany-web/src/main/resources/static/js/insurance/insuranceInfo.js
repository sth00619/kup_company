$(document).ready(function(){
    ...
    const insuranceManageNo = $('#insuranceManageNo').val();
    ...
    $('._close_btn').on('click', function(){
        ...
        if(preUrl.match('addInsurance') || preUrl.match('updateInsurance')){
            preUrl = "/insurance/insurance";
        }
    ...
    $(document).on('click', '._deleteBtn', function(){
        ...
        if(result) {
            var url = "/insurance/deleteInsuranceInfo?insuranceManageNo="+insuranceManageNo
    ...
    function minusAmount(){
        ...
        $.each(_insuranceAmount, function(){
            ...
            let type = $(this).closest('._insurance_info_box').find('._achieveCheck').attr('value');
