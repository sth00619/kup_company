$(document).ready(function () {
    ...
    function setAchievement(percentMap){
        ...
        // 1) 360도 퍼센트 바
        $('._chart_bar1').css('--background', 'conic-gradient(#304260 ' + Math.floor(roundPercentMax * percentMap.percentA / 100) + 'deg, #f4f6fa 50deg)');
        $('._chart_bar2').css('--background', 'conic-gradient(#42ceb5 ' + Math.floor(roundPercentMax * percentMap.percentB / 100) + 'deg, #f4f6fa 50deg)');
        $('._chart_bar3').css('--background', 'conic-gradient(#9199a6 ' + Math.floor(roundPercentMax * percentMap.percentC / 100) + 'deg, #f4f6fa 50deg)');
        $('._chart_bar4').css('--background', 'conic-gradient(#a9b5c7 ' + Math.floor(roundPercentMax * percentMap.percentD / 100) + 'deg, #f4f6fa 50deg)');

        const child_1 = $(".my_chart:nth-child(1)");
        const child_2 = $(".my_chart:nth-child(2)");
        const child_3 = $(".my_chart:nth-child(3)");
        const child_4 = $(".my_chart:nth-child(4)");
