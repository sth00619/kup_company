$(document).ready(function () {
    ...
    $(document).on('click', '._counseling_title', function () {
        ...
        var advice = $('#advice')
        var str = '';
        str += '<div class="advice_txt_inner">'
    ...
    $(document).on('click', '#counselingSaveBtn', function () {
        ...
        var data = {
            "candidateEmployeeNo": candidateEmployeeNoForm,
            "insert": insertForm,
            "update": updateForm,
            "delete": deleteForm
        }
        ...
        $.ajax({
            url: "/candidate/counseling/addCounseling",
            type: "POST",
    ...
    $(document).on('click', '.advice_click', function () {
        ...
        var sub_title = $(this).closest('.candisub_title');
        var candidateEmployeeNo = sub_title.find('._candidateEmployeeNo').attr('value');


        candidateEmployeeNoForm = candidateEmployeeNo;
        var data = {
            'candidateEmployeeNo': candidateEmployeeNo,
            'isForm': 'true'
        }

        var str = ''
        str += '<input id ="userNo" name="candidateEmployeeNo" value ='
        str += candidateEmployeeNo
        str += ' hidden>'
        ...
        $.ajax({
            type: "GET",
            url: "/candidate/counseling/detail",
            data: data,
            success: function (fragment) {
    ...
    function searchPotentialUser() {
        ...
        if (getEmployeeCode == null || getEmployeeCode == '' || typeof getEmployeeCode == "undefined") {
            ...
            if (getDepartmentCode != null) {
                location.href = '/candidate/list?departmentCode=' + getDepartmentCode + '&searchType=' + searchType + "&keyword=" + keyword;
            } else {
                location.href = '/candidate/list?employeeCode=' + getEmployeeLoginCode + '&departmentCode=' + getDepartmentCode + '&searchType=' + searchType + "&keyword=" + keyword;
            }
        } else {
            location.href = '/candidate/list?employeeCode=' + getEmployeeCode + '&departmentCode=' + getDepartmentCode + '&searchType=' + searchType + "&keyword=" + keyword;
        }
    }
